    ...
    <div class="wsus__chat_area">
        ...
        <div class="wsus__chat_area_footer">
            <div class="footer_message">
                ...
                <form action="#" id="note" name="myForm" class="message-form" enctype="multipart/form-data">
                    <div class="file">
                    ...
                    <textarea id="example1"  type="submit" form="note"
         rows="1" placeholder="Type a message.." name="message" class="message-input"></textarea>

                    <button name="myInputButton" type="submit"><i class="fas fa-paper-plane"></i></button>
                </form>
            </div>
        </div>
    </div>
